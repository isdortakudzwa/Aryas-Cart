  ...
  return (
    <nav className="navbar">
      <div className="logo-container">
        <a href="/">
          <img src={logos} alt="Brand Logo" className="logo" />
        </a>
      </div>
      ...
      <ul className={`nav-links ${isMenuOpen ? 'active' : ''}`}>
        ...
        <li><Link href="/about" className="nav-link" onClick={closeMenu}>
        ...
        <li><Link href="/collections" className="nav-link" onClick={closeMenu}>
          <span className="link-text">Collections</span>
        </Link></li>
        <li><Link href="/contact" className="nav-link" onClick={closeMenu}>
